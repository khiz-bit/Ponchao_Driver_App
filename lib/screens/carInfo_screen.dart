...
class _CarInfoScreenState extends State<CarInfoScreen> {
  ...
  List<String> carTypes = ["Car", "Eco Car", "Bike"];
  ...
  _submit() {
    if(_formKey.currentState!.validate()){
      Map driverCarInfoMap = {
        ...
        "type": carTypeTextEditingController.text.trim(),
      };
      ...
      child: Scaffold(
        body: ListView(
          ...
          children: [
            Column(
              children: [
                Image.asset(darkTheme ? 'images/city_dark.jpg' : 'images/city-light.jpg'),
                            ...
                            DropdownButtonFormField(
                                ...
                                onChanged: (newValue) {
                                  setState(() {
                                    ...
                                    carTypeTextEditingController.text = newValue.toString();
                                  });
                                }
                            ),
